...
export const edgeCases: { q: Bilingual; a: Bilingual }[] = [
  ...
  { q: { pl: "Czy Kolejarz może wywieźć sam siebie?", en: "Can the Conductor ship themselves out of town?" }, a: { pl: "NIE.", en: "NO." } },
  { q: { pl: "Czy Detektyw może sprawdzić sam siebie?", en: "Can the Detective investigate themselves?" }, a: { pl: "NIE.", en: "NO." } },
  { q: { pl: "Czy Detektyw może sprawdzić osobę wywiezioną przez Kolejarza?", en: "Can the Detective investigate a person shipped out by the Conductor?" }, a: { pl: "NIE.", en: "NO." } },
  ...
  { q: { pl: "Gdy Barman przesunie kulę Mafii, a kula trafi na osobę wywiezioną przez Kolejarza, co się dzieje?", en: "When the Bartender shifts the Mafia's bullet and it lands on a person shipped out by the Conductor, what happens?" }, a: { pl: "NIKT NIE ZOSTAJE WYELIMINOWANY.", en: "NO ONE IS ELIMINATED." } },
  ...
  { q: { pl: "Jeżeli Terrorysta umrze, a obok siebie ma osobę wywiezioną przez Kolejarza, co się dzieje?", en: "If the Bomber dies and the person next to them has been shipped out by the Conductor, what happens?" }, a: { pl: "NIKT NIE ZOSTAJE WYELIMINOWANY Z TEJ STRONY.", en: "NO ONE IS ELIMINATED ON THAT SIDE." } },
...
const anySyndicate = ["bartender", "mayor", "terrorist", "chairmans-daughter"];

export const sampleSets: SampleSet[] = [
  {
    players: 6, stats: "4-2-0",
    city: [{ id: "doctor" }, { id: "detective" }, { id: "lady" }, { id: "infantry" }],
    mafia: [{ id: "mafia-boss" }, { id: "coquette" }],
    syndicate: [],
  },
  {
    players: 7, stats: "4-2-1",
    city: [{ id: "doctor" }, { id: "detective" }, { id: "lady" }, { id: "loose-cannon" }],
    mafia: [{ id: "mafia-boss" }, { id: "coquette" }],
    syndicate: [{ anyOf: anySyndicate, pick: 1 }],
  },
  {
    players: 8, stats: "5-2-1",
    city: [{ id: "doctor" }, { id: "detective" }, { id: "lady" }, { id: "loose-cannon" }, { oneOf: ["infantry", "gun-owner"] }],
    mafia: [{ id: "blackmailer-boss" }, { id: "coquette" }],
    syndicate: [{ anyOf: anySyndicate, pick: 1 }],
  },
  {
  ...
  },
  {
    ...
    city: [{ id: "doctor" }, { id: "detective" }, { id: "lady" }, { id: "loose-cannon" }, { id: "saint" }],
    mafia: [{ id: "mafia-boss" }, { id: "coquette" }, { id: "janitor" }],
    syndicate: [{ anyOf: anySyndicate, pick: 2 }],
  },
  {
    players: 11, stats: "6-3-2",
    city: [{ id: "doctor" }, { id: "detective" }, { id: "lady" }, { id: "loose-cannon" }, { oneOf: ["infantry", "gun-owner"] }, { oneOf: ["railwayman", "chairman"] }],
    mafia: [{ id: "mafia-boss" }, { id: "coquette" }, { id: "janitor" }],
    syndicate: [{ id: "bartender" }, { anyOf: ["angel-of-death", "mayor", "terrorist", "chairmans-daughter"], pick: 1 }],
  },
  {
    players: 12, stats: "6-3-3",
    city: [{ id: "doctor" }, { id: "detective" }, { id: "lady" }, { id: "loose-cannon" }, { oneOf: ["infantry", "gun-owner"] }, { oneOf: ["railwayman", "chairman"] }],
    mafia: [{ id: "mafia-boss" }, { id: "coquette" }, { id: "janitor" }],
    syndicate: [{ id: "bartender" }, { anyOf: ["angel-of-death", "mayor", "terrorist", "chairmans-daughter"], pick: 2 }],
  },
  {
    players: 13, stats: "7-3-3",
    city: [{ id: "doctor" }, { id: "detective" }, { id: "lady" }, { id: "loose-cannon" }, { oneOf: ["infantry", "gun-owner"] }, { oneOf: ["railwayman", "chairman"] }, { id: "bodyguard" }],
    mafia: [{ id: "blackmailer-boss" }, { id: "coquette" }, { id: "janitor" }],
    syndicate: [{ id: "bartender" }, { id: "angel-of-death" }, { anyOf: ["mayor", "terrorist", "chairmans-daughter"], pick: 1 }],
  },
  {
    players: 14, stats: "7-3-4",
    city: [{ id: "doctor" }, { id: "detective" }, { id: "lady" }, { id: "loose-cannon" }, { oneOf: ["infantry", "gun-owner"] }, { oneOf: ["railwayman", "chairman"] }, { id: "bodyguard" }],
    mafia: [{ id: "blackmailer-boss" }, { id: "coquette" }, { id: "janitor" }],
    syndicate: [{ id: "bartender" }, { id: "angel-of-death" }, { id: "terrorist-plus" }, { anyOf: ["mayor", "chairmans-daughter"], pick: 1 }],
  },
  {
    players: 15, stats: "8-3-4",
    city: [{ id: "doctor" }, { id: "detective" }, { id: "lady" }, { id: "loose-cannon" }, { oneOf: ["infantry", "gun-owner"] }, { id: "railwayman" }, { id: "chairman" }, { id: "bodyguard" }],
    mafia: [{ id: "blackmailer-boss" }, { id: "coquette" }, { id: "janitor" }],
    syndicate: [{ id: "bartender" }, { id: "angel-of-death" }, { id: "terrorist-plus" }, { anyOf: ["mayor", "chairmans-daughter"], pick: 1 }],
  },
  {
    players: 16, stats: "8-4-4",
    city: [{ id: "doctor" }, { id: "detective" }, { id: "lady" }, { id: "loose-cannon" }, { oneOf: ["infantry", "gun-owner"] }, { id: "railwayman" }, { id: "chairman" }, { id: "saint" }],
    mafia: [{ id: "mafia-boss" }, { id: "blackmailer" }, { id: "coquette" }, { id: "janitor" }],
    syndicate: [{ id: "bartender" }, { id: "angel-of-death" }, { id: "terrorist-plus" }, { anyOf: ["mayor", "chairmans-daughter"], pick: 1 }],
  },
  {
    players: 17, stats: "9-4-4",
    city: [{ id: "doctor" }, { id: "detective" }, { id: "lady" }, { id: "loose-cannon" }, { oneOf: ["infantry", "gun-owner"] }, { id: "railwayman" }, { id: "chairman" }, { id: "saint" }, { id: "bodyguard" }],
    mafia: [{ id: "mafia-boss" }, { id: "blackmailer" }, { id: "coquette" }, { id: "janitor" }],
    syndicate: [{ id: "bartender" }, { id: "angel-of-death" }, { id: "terrorist-plus" }, { anyOf: ["mayor", "chairmans-daughter"], pick: 1 }],
  },
  {
    ...
    city: [{ id: "doctor" }, { id: "detective" }, { id: "lady" }, { id: "loose-cannon" }, { oneOf: ["infantry", "gun-owner"] }, { id: "railwayman" }, { id: "chairman" }, { id: "saint" }, { id: "bodyguard" }],
    mafia: [{ id: "mafia-boss" }, { id: "blackmailer" }, { id: "coquette" }, { id: "janitor" }],
    syndicate: [{ id: "bartender" }, { id: "angel-of-death" }, { id: "terrorist-plus" }, { id: "mayor" }, { id: "chairmans-daughter" }],
  },
  {
    players: 19, stats: "10-4-5",
    city: [{ id: "doctor" }, { id: "detective" }, { id: "lady" }, { id: "loose-cannon" }, { id: "infantry" }, { id: "gun-owner" }, { id: "railwayman" }, { id: "chairman" }, { id: "saint" }, { id: "bodyguard" }],
    mafia: [{ id: "mafia-boss" }, { id: "blackmailer" }, { id: "coquette" }, { id: "janitor" }],
    syndicate: [{ id: "bartender" }, { id: "angel-of-death" }, { id: "terrorist-plus" }, { id: "mayor" }, { id: "chairmans-daughter" }],
  },
  {
    players: 20, stats: "10-5-5",
    city: [{ id: "doctor" }, { id: "detective" }, { id: "lady" }, { id: "loose-cannon" }, { id: "infantry" }, { id: "gun-owner" }, { id: "railwayman" }, { id: "chairman" }, { id: "bodyguard" }, { id: "citizen" }],
    mafia: [{ id: "mafia-boss" }, { id: "blackmailer" }, { id: "coquette" }, { id: "janitor" }, { id: "mafioso" }],
    syndicate: [{ id: "bartender" }, { id: "angel-of-death" }, { id: "terrorist-plus" }, { id: "mayor" }, { id: "chairmans-daughter" }],
  },
  {
    players: 21, stats: "11-5-5",
    city: [{ id: "doctor" }, { id: "detective" }, { id: "lady" }, { id: "loose-cannon" }, { id: "infantry" }, { id: "gun-owner" }, { id: "railwayman" }, { id: "chairman" }, { id: "bodyguard" }, { id: "citizen", count: 2 }],
    mafia: [{ id: "mafia-boss" }, { id: "blackmailer" }, { id: "coquette" }, { id: "janitor" }, { id: "mafioso" }],
    syndicate: [{ id: "bartender" }, { id: "angel-of-death" }, { id: "terrorist-plus" }, { id: "mayor" }, { id: "chairmans-daughter" }],
  },
  {
    players: 22, stats: "12-5-5",
    city: [{ id: "doctor" }, { id: "detective" }, { id: "lady" }, { id: "loose-cannon" }, { id: "infantry" }, { id: "gun-owner" }, { id: "railwayman" }, { id: "chairman" }, { id: "bodyguard" }, { id: "citizen", count: 3 }],
    mafia: [{ id: "mafia-boss" }, { id: "blackmailer" }, { id: "coquette" }, { id: "janitor" }, { id: "mafioso" }],
    syndicate: [{ id: "bartender" }, { id: "angel-of-death" }, { id: "terrorist-plus" }, { id: "mayor" }, { id: "chairmans-daughter" }],
  },
  {
    ...
    city: [{ id: "doctor" }, { id: "detective" }, { id: "lady" }, { id: "loose-cannon" }, { id: "infantry" }, { id: "gun-owner" }, { id: "railwayman" }, { id: "chairman" }, { id: "bodyguard" }, { id: "citizen", count: 3 }],
    mafia: [{ id: "mafia-boss" }, { id: "blackmailer" }, { id: "coquette" }, { id: "janitor" }, { id: "mafioso", count: 2 }],
    syndicate: [{ id: "bartender" }, { id: "angel-of-death" }, { id: "terrorist-plus" }, { id: "mayor" }, { id: "chairmans-daughter" }],
  },
];
